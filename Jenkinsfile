pipeline {
    ...
    parameters {
        ...
        string(name: 'SERVER_FQDN',
               defaultValue: 'ec2-3-84-200-167.compute-1.amazonaws.com',    // non-jenkins
               //defaultValue: 'ec2-34-224-56-197.compute-1.amazonaws.com', // jenkins
    ...
    stages {
        ...
        stage('Base installation') {
            ...
            steps {
                ...
                sh "ssh -o StrictHostKeyChecking=no -i ${env.SERVER_LOGIN} ${params.SSH_USER}@${params.SERVER_FQDN} 'sudo wget -O /etc/nginx/sites-available/default https://raw.githubusercontent.com/J3GI/ci-cd-test/aws/nginx.conf'"
